...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('Дата окончания', sa.DateTime(timezone=True), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            'Тип подписки',
            sa.Enum(
                'ONE_MONTH', 'TWO_MONTHS', 'SIX_MONTHS', 'YEAR', name='subscriptiontype'
            ),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            'Роль',
            sa.Enum('OWNER', 'ADMIN', 'EDITOR', 'VIEWER', name='userrolecompany'),
            nullable=False,
        ),
        sa.ForeignKeyConstraint(
            ['company_id'],
    ...
    op.create_table(
        ...
        sa.Column('Дата рождения', sa.DateTime(timezone=True), nullable=False),
        sa.Column('Дата приобретения', sa.DateTime(timezone=True), nullable=False),
        sa.Column(
            'Пол',
    ...
    op.create_table(
        ...
        sa.Column('Дата измерения', sa.DateTime(timezone=True), nullable=False),
        sa.Column(
            'Дата обновления',
            sa.DateTime(timezone=True),
            server_default=sa.text('now()'),
    ...
    op.create_table(
        ...
        sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
        sa.Column('pet_id', sa.Integer(), nullable=False),
        sa.Column('Дата линьки', sa.DateTime(timezone=True), nullable=False),
        sa.Column('description', sa.String(), nullable=True),
        sa.Column(
            'Дата обновления',
            sa.DateTime(timezone=True),
    ...
    op.create_table(
        ...
        sa.Column('description', sa.String(), nullable=True),
        sa.Column('pet_id', sa.Integer(), nullable=False),
        sa.Column('Дата взвешивания', sa.DateTime(timezone=True), nullable=False),
        sa.Column(
            'Дата обновления',
            sa.DateTime(timezone=True),
            server_default=sa.text('now()'),
